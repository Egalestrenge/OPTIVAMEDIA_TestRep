...
2. El personaje, dependiendo del entorno, tiene su cuerpo en dos posibles estados: estado material y estado espiritual. La forma en la que el jugador es capaz de controlar al personaje depende de estas dos formas. En particular:
...
Nótese que el último punto depende de factores externos al personaje (distribución de luces en el nivel) como de distintas propiedades del material que usa el personaje (a las cuales se pueden acceder mediante un Material Data Table para que puedan ser accedidas d
